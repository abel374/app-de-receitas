    ...
    return (
        <div className='container mx-auto my-20'>
            <div className='flex border-2 border-gray-300 cursor-pointer p-4'>
                <div className='relative w-[50%] h-[500px] mr-8'> <Image src={data?.meals[0].strMealThumb} layout="fill" object="cover" alt="meal image" /> </div>
                <div className='w-[50%]'>
                    <h1 className='py-4 text-gray-500 font-semibold text-2xl text-center mb-4'> {data?.meals[0]?.strMeal}</h1>
                    {/* Ingredients Card */}
